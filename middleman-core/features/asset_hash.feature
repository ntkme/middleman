Feature: Assets get file hashes appended to them and references to them are updated
  ...
  Scenario: Hashed assets work in preview server
    ...
    And I should see 'href="stylesheets/site-59cf55ef.css"'
    And I should see 'href="stylesheets/fragment-a04d8424.css"'
    ...
    And I should see 'src="images/100px-5fd6fb90.jpg#test"'
    When I go to "/subdir/"
    Then I should see 'href="../stylesheets/site-59cf55ef.css"'
    And I should see 'src="../javascripts/application-1d8d5276.js"'
    And I should see 'src="../images/100px-5fd6fb90.jpg"'
    When I go to "/other/"
    Then I should see 'href="../stylesheets/site-59cf55ef.css"'
    ...
    When I go to "/stylesheets/site-59cf55ef.css"
    ...
    And I should see 'images/100px-5fd6fb90.jpg'
    And I should see 'images/100px-1242c368.png'
    When I go to "/stylesheets/fragment-a04d8424.css"
